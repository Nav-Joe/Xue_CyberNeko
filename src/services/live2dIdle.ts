import type { Live2DModel, MotionPreloadStrategy } from 'pixi-live2d-display/cubism4'

/** 占位组名：库在无动作时会尝试播放 Idle，指向不存在的组即可静默跳过 */
const DISABLED_IDLE_GROUP = '__quiet_idle_disabled__'

/** 勿 value-import cubism4；MotionPreloadStrategy.NONE === 0 */
export const QUIET_IDLE_MODEL_OPTIONS = {
  autoInteract: false,
  autoUpdate: true,
  idleMotionGroup: DISABLED_IDLE_GROUP,
  motionPreload: 0 as unknown as MotionPreloadStrategy
}
